 ...
 * Takes in key/value pairs and assigns the input value to whatever configuration variable is indicated by the key.
 ...
 * Returns the value associated with the supplied input key on success, and -1 on failure
 * This assumes there are no keys for which a negative return value is permissible. 
*/
